...
class SatislarMusteriBody extends StatefulWidget {
  SatislarMusteriBody({Key? key}) : super(key: key);

  final Equatable headers = EntitiesModelRepositories().musterilerHeader;
  final List<Equatable> body = EntitiesModelRepositories().musteriler;
  @override
  _SatislarMusteriBodyState createState() => _SatislarMusteriBodyState();
}
