...
class AlislarTedarikciBody extends StatefulWidget {
  AlislarTedarikciBody({Key? key}) : super(key: key);
  final Equatable headers = EntitiesModelRepositories().tedarikcilerHeader;
  final List<Equatable> body = EntitiesModelRepositories().tedarikciler;

  @override
  _AlislarTedarikciBodyState createState() => _AlislarTedarikciBodyState();
}

class _AlislarTedarikciBodyState extends State<AlislarTedarikciBody> {
  @override
