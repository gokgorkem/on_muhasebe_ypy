...
class BankaIslemBody extends StatefulWidget {
  BankaIslemBody({Key? key}) : super(key: key);

  final Equatable headers = EntitiesModelRepositories().islemlerHeader;
  final List<Equatable> body = EntitiesModelRepositories().islemler;
  @override
  _BankaIslemBodyState createState() => _BankaIslemBodyState();
}

class _BankaIslemBodyState extends State<BankaIslemBody> {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(flex: 8,child: _buildListViewBankaIslem()),
        Expanded(flex: 1,child: Container())
      ],
    );
  }

  ListView _buildListViewBankaIslem() {
