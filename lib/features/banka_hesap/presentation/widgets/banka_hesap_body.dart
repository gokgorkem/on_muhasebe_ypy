...
class BankaHesapBody extends StatefulWidget {
  BankaHesapBody({Key? key}) : super(key: key);

  final Equatable headers = EntitiesModelRepositories().hesaplarHeader;
  final List<Equatable> body = EntitiesModelRepositories().hesaplar;
  @override
  _BankaHesapBodyState createState() => _BankaHesapBodyState();
}
