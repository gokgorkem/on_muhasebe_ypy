...
class AlislarOdemeBody extends StatefulWidget {
  AlislarOdemeBody({Key? key}) : super(key: key);
  final Equatable headers = EntitiesModelRepositories().odemelerHeader;
  final List<Equatable> body = EntitiesModelRepositories().odemeler;

  @override
  _AlislarOdemeBodyState createState() => _AlislarOdemeBodyState();
}
    ...
    return Column(
      children: [
        Expanded(flex: 1,child: Container(child: Row(
          ...
          children: [
            TextButton(child: Text("Yeni Ödeme"),onPressed: () => Navigator.of(context).pushNamed(ALISLAR_YENI_ODEME_PAGE_ROUTE),),
          ],
        ),)),
