...
class BankaTransferBody extends StatefulWidget {
  BankaTransferBody({Key? key}) : super(key: key);

  final Equatable headers = EntitiesModelRepositories().transferlerHeader;
  final List<Equatable> body = EntitiesModelRepositories().transferler;
  @override
  _BankaTransferBodyState createState() => _BankaTransferBodyState();
}

class _BankaTransferBodyState extends State<BankaTransferBody> {
  @override
  ...
  ListView _buildListViewBankaTransfer() {
